...
const weatherForecastSlice = createSlice({
    name: "weatherForecast", initialState: {
        locationForecast: {}, status: "idle", latLng: {}, descriptionOfPlace: "",
    }, reducers: {
...
export const {
    setWeatherCardClear, getLatLngFromLibrary, getForecastSuccess, getForecastError, setDescriptionOfPlace,
